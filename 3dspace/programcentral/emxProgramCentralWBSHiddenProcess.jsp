        ...
        //End:26-Mar-2010:s2e:R209 PRG:IR-022896V6R2011
          ...
          if(!(taskId.equals("0")|taskId.contains("0,")))
          {
          ...
          }  finally 
             {
	       	...
	       	if(istypeProjectSpace && calledMethod.equalsIgnoreCase("submitDeleteTask")){
	   	   		blProjSelected=true;
...
<script language="javascript" type="text/javaScript">//<![CDATA[
    ...
    if(parent.emxEditableTable.checkDataModified() && (calledMethod == "submitAddTask" || calledMethod == "submitInsertTask")){
        alert("<framework:i18nScript localize="i18nId">emxProgramCentral.Common.SaveWBSModification</framework:i18nScript>");
...
<%
				...
				var strProjectRelIds = '<%=selectedSubProjectRelIds%>'; 
				var selectedProjectIds = '<%=XSSUtil.encodeForJavaScript(context,selectedProjectIds)%>';
				document.location.href = "emxProgramCentralUtil.jsp?objectId="+projId+"&selectedIds="+strProjectRelIds+"&mode="+action+"&fromPage=StructureBrowser&selectedProjectIds="+selectedProjectIds;
				<%
			}
%>  
     	  } // eof if
...
<%
 ...
 if('<%=blTaskSelected%>' == "true"){
      ...
      if(projectSelected == "true"){
         ...
         document.location.href = "emxProgramCentralUtil.jsp?objectId="+projId+"&selectedIds="+selectedIds+"&mode="+action+"&fromPage=StructureBrowser&selectedProjectIds="+selectedProjectIds;
      }// eof if
    }
