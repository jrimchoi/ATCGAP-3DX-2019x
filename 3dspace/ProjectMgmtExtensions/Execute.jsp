...
<%@page import="com.dassault_systemes.enovia.projectmgmtextensions.ExecuteCallable"%>
...
<%	
	...
	try 
	{
		...
		FrameworkUtil.validateMethodBeforeInvoke(context, programName, methodName, com.dassault_systemes.enovia.projectmgmtextensions.ExecuteCallable.class); 
		//END
