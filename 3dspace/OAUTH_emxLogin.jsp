...
if (Framework.isLoggedIn(request))
{
    ...
    //JPA-
    targetPage = "oslc/OAUTH_emxSecurityContextSelection.jsp?rToken=" + request.getParameter("rToken") + "&port=" + request.getParameter("port") + "&ticket=" + request.getParameter("ticket");
...
%>
    ...
    if ((FrameworkTarget != null) && (!"".equals(FrameworkTarget)))
    {
        if( FrameworkTarget.contains("emxNavigator.jsp") && forwardURL != null )
        {
            ...
            FrameworkTarget = "/" + FrameworkTarget.split("/")[1] + "/" + FrameworkTarget.split("/")[2] + "/OAUTH_" + FrameworkTarget.split("/")[3] + "?rToken=" + request.getParameter("rToken") + "&port=" + request.getParameter("port") + "&ticket=" + request.getParameter("ticket");
