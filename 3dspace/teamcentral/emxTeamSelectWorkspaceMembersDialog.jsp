...
<%
  ...
  MapList mapList = DomainObject.findObjects(context, typeSecurityContext, objectNamePattern, DomainObject.QUERY_WILDCARD, DomainObject.QUERY_WILDCARD, DomainObject.QUERY_WILDCARD, sBusWhere, objectNamePattern, true, selects, (short)0,null, null, personAttrMultiValueList);
