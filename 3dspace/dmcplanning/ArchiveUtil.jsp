...
{	
  ...
  StringList mpidslist = new StringList();
    if(strTableRowIds!=null && !strTableRowIds[0].endsWith("|0"))
      {
       for(int i=0;i<strTableRowIds.length;i++)
        {
          ...
          String strAlertMessage = EnoviaResourceBundle.getProperty(context,"DMCPlanning",
                          "DMCPlanning.Error.RootNode",language);
    ...
    //convertign String[] to String List
     ...
     boolean archived=mPlanBean.archive(context,mpidslist);
