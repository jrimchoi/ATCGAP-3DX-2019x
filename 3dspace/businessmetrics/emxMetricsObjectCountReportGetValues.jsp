<%--  emxMetricsObjectCountReportGetValues.jsp
    Copyright (c) 2005-2018 Dassault Systemes.
    All Rights Reserved.
    This program contains proprietary and trade secret information of MatrixOne,Inc.
    Copyright notice is precautionary only
    and does not evidence any actual or intended publication of such program
    static const char RCSID[] = $Id: emxMetricsObjectCountReportGetValues.jsp.rca 1.9 Wed Oct 22 16:11:56 2008 przemek Experimental $
--%>
...
<%
    ...
    String searchBasics = (String)EnoviaResourceBundle.getProperty(context, "emxMetrics.MetricsReports.ObjectCountBasicAttributes");
    ...
    for(int l=0;l<basicList.size();l++ ){
        ...
        String sBasicAttr = i18nNow.getBasicI18NString(strBasicAttr,strLanguage);
        attrBuffer.append ("<option value =\""+ strBasicAttr + "\">" + sBasicAttr + "</option>"); 
    }
    while ( attrItr.hasNext() ){
        ...
        attrBuffer.append ("<option value =\""+ attributeName + "\">" + sAttributeName + "</option>"); 
    }
    StringBuffer sbGroupBy = new StringBuffer ("<select name=\"lstGroupBy\" style=\"width:190\" id=\"lstGroupBy\" onChange=\"javascript:updateSubgroup();\">");
