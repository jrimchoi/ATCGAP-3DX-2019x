<%-- emxMetricsObjectCountOverTimeReport.jsp
   ...
   static const char RCSID[] = $Id: emxMetricsObjectCountOverTimeReport.jsp.rca 1.10 Wed Oct 22 16:11:57 2008 przemek Experimental $
...
<%   
    ...
    try{
        ...
        typeChooserURL = "../common/emxTypeChooser.jsp?callbackFunction=updateAttributesForOverTime&formName=MetricsObjectCountOverTimeReportForm&frameName=metricsReportContent&fieldNameActual=txtTypeActual&fieldNameDisplay=txtTypeDisplay";
    ...
    if ((strContainedInRev == null) || "null".equalsIgnoreCase(strContainedInRev))
     {
        ...
        if(ex.toString() != null && (ex.toString().trim()).length()>0){
            emxNavErrorObject.addMessage("emxMetricsObjectCountOverTimeDialog :" + ex.toString().trim());
        }
    }
    finally{
...
<title></title>
    ...
    <script type="text/javascript" src="emxMetricsObjectCountOverTimeUtils.js"></script>
...
<body onload="getTopWindow().loadReport(); setTimeout('doLoad()',100); turnOffProgress();">
    <form method="post" name="MetricsObjectCountOverTimeReportForm" id="MetricsObjectCountOverTimeReportForm">
        ...
        <table border="0" cellpadding="5" cellspacing="2" width="100%">
            <tr>
              ...
              <td class="inputField">
                  <input type="text" name="txtTypeDisplay" id="txtTypeDisplay" value="<%=translatedTypeNames%>" size="20" readonly="readonly" onChange="updateType(this.value);" />
...
%>
                            ...
                            <td><input type="radio" name="vaultSelction" value="SELECTED_VAULT" <%=checked%> />
                                ...
                                <input name="btnType" type="button" value="..." onclick="javascript:setSelectedVaultOptionForOverTime()" />
            ...
            <tr>
                ...
                <td nowrap class="inputField">
                    <table>
                        <tr>
                            <td>
                                <div id="grpBydiv" style="visibility:visible">
                                    <select name="lstGroupBy" id="lstGroupBy" onChange="javascript:updateSubgroupForOverTime();">
                                    </select>
                                </div>
                            </td>
                            <td>&nbsp;&nbsp;</td>
                            ...
                            <td>
                                <div id="subGrpBydiv" style="visibility:visible">
...
%>
		...
		function showAffectedItemSelector(){
		  var sURL= "../common/emxSearch.jsp?formName=MetricsObjectCountOverTimeReportForm&containedInFlag=false&defaultSearch=AEFContainedInSearch";
