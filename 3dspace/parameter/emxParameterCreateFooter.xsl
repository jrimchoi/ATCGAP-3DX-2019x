                ...
                <div id="divDialogButtons">
                        <table>
                                ...
                                <td class="buttons">
                                        <table>
                                                <tr>
                                                <td><a class="footericon" href="javascript:void(0)" onClick="parameterSaveCreateChanges(false,'{$targetLocation}')"><img src="../common/images/buttonDialogDone.gif" border="0" alt="Done"/></a></td>
                                    <td><a href="javascript:void(0)" onClick="parameterSaveCreateChanges(false,'{$targetLocation}')" class="button"><button class="btn-primary" type="button"><xsl:value-of select="aef:setting[@name = 'done']"/></button></a></td>
                                    <td>&amp;#160;</td>
                                                  <xsl:if test="$showApply = 'true'">
                                                       <td><a class="footericon" href="javascript:void(0)" onClick="parameterSaveCreateChanges(true,'{$targetLocation}')"><img src="../common/images/buttonDialogApply.gif" border="0" alt="Apply"/></a></td>
                                   <td><a href="javascript:void(0)" onClick="parameterSaveCreateChanges(true,'{$targetLocation}')" class="button"><button class="btn-default" type="button"><xsl:value-of select="aef:setting[@name = 'apply']"/></button></a></td>
                                   <td>&#160;</td>
                                                  </xsl:if>
                                                  <xsl:choose>
                                                      <xsl:when test="$targetLocation = 'slidein' or $slideinType = 'wider'">
                                                        <td><div id="cancelImage"><a class="footericon" href="javascript:void(0)" onClick="closeSlideinWindow(getTopWindow())"><img src="../common/images/buttonDialogCancel.gif" border="0" alt="Cancel"/></a></div></td>
                                                      ...
                                                      <xsl:otherwise>
                                                    <td><div id="cancelImage"><a class="footericon" href="javascript:void(0)" onClick="closePopupWindow(getTopWindow())"><img src="../common/images/buttonDialogCancel.gif" border="0" alt="Cancel"/></a></div></td>
