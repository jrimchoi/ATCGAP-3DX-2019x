<%--  emxParameterCreate.jsp
   ...
   static const char RCSID[] = $Id: emxParameterCreate.jsp.rca 1.13.1.2.1.4 Wed Oct 22 15:48:40 2008 przemek Experimental przemek $
--%>
...
String xsltFile 	= "emxParameterCreatePage.xsl";
...
//End : IR-044112V6R2011
    ...
    try {
        ...
        i18strCancel 	= EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", locale, "emxFramework.Button.Close");
    ...
    StringBuffer toolbarURL = new StringBuffer("../common/emxToolbarJavaScript.jsp?uiType=form&printerFriendly=false&export=false&timeStamp=");
    ...
    request.getRequestDispatcher("../common/emxFormConstantsJavascriptInclude.jsp").include(request, customResponse);
    ...
    customResponse  = new CharArrayWriterResponse(response);
    request.getRequestDispatcher("../common/emxJSValidation.jsp").include(request, customResponse);
    ...
    //out.clear();
	String realPath = request.getServletContext().getRealPath("/parameter");
    XSLTransformer transformer = new XSLTransformer(new java.io.File(realPath, xsltFile));
