...
<%!
private String getI18NString(Context context, Helper.StringResource stringResource, String key) throws ESRInquiryException {
	try {
...
function preProcessReturn() 
{
	...
	var loggedInUser = "<%=XSSUtil.encodeForHTMLAttribute(context, context.getUser()) %>"; //XSSOK
	var loggedInUserFullName = "<%=XSSUtil.encodeForHTMLAttribute(context, com.matrixone.apps.domain.util.PersonUtil.getFullName(context))%>"; //XSSOK
