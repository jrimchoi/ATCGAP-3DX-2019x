...
<script language="javascript" src="emxInfoUISearch.js"></script>
...
<%
	try {
		...
		String queryName = emxGetParameter(request, "queryName");
...
<form name="frmPowerSearch" id="idForm" method="post" action="DSCModifyQuery.jsp" target="_parent" onSubmit="return false">
<%
...
//System.out.println("CSRFINJECTION::DSCModifyQueryDialog.jsp::form:frmPowerSearch");
%>
...
<input type=hidden name="comboFormatsHidden" value="<xss:encodeForHTMLAttribute><%=comboFormat%></xss:encodeForHTMLAttribute>">
...
<table border="0" cellspacing="2" cellpadding="3" width="100%" >
  <tr>
    ...
    <td class="inputField">
	  <!--XSSOK-->
      <input type=text value="<%=sTxtType%>" size="16" name="txtType" <%=sKeyPress%>>
	  <!--XSSOK-->
  ...
  <tr>
    ...
    <!--XSSOK-->
    <td class="inputField"><input type="text" name="txtName" size="16" value="<%=sTxtName%>" <%=sKeyPress%>></td>
  </tr>
  <tr>
    <td class="label"><%=i18nNow.getBasicI18NString("Revision",  languageStr)%>
		</td>
	<!--XSSOK-->
    <td class="inputField"><input type="text" name="txtRev" size="16" value="<%=sTxtRev%>" <%=sKeyPress%>></td>
  </tr>
   <tr>
    <td class="label"><%=i18nNow.getBasicI18NString("Owner",  languageStr)%>
		</td>
	<!--XSSOK-->
    <td class="inputField"><input type="text" name="txtOwner" size="16" value="<%=sTxtOwner%>" <%=sKeyPress%>></td>
  </tr>
  <tr>
   <td class="label">
	 ...
	 <!--XSSOK-->
     <td class="inputField"><input type=text  name="txtVault" size="16" value="<%=sTxtVault%>" <%=sKeyPress%>>&nbsp;<input class="button" type="button" size = "200" value="..." alt="..." onClick="javascript:showVaultSelector();"></td>
  </tr>
  <%
    if((null == advanced) || 
