<%--  emxDSCWorkspaceMgmtCopyMoveFiles.jsp
...
--%>
<%--  IEFDSCWorkspaceMgmtCopyMoveFiles.jsp - Perform copy/move on selected files
...
<%
   ...
   String action = emxGetParameter(request, "action");  // "copy", "move"
   ...
   if(integSessionData != null)
   {
      try
      {
         ...
         String methodName = (action.equalsIgnoreCase("copy")) ? "copyWSMFiles" : "moveWSMFiles";
%>
         ...
         <script language="JavaScript">
			...
			//XSSOK
            mxmcadApplet.callCommandHandler('<%= integName %>', "<%= methodName %>", appletFileBoidList);
         </script>
<%
      }
