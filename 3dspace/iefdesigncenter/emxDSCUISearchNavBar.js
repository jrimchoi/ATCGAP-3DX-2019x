...
//
//
//   static const char RCSID[] = $Id: /ENODesignerCentral/CNext/webroot/iefdesigncenter/emxDSCUISearchNavBar.js 1.3.1.3 Sat Apr 26 10:22:24 2008 GMT ds-mbalakrishnan Experimental$
//   ================================================================
...
if (!objMgr)
  alert("Object Manager could not be located.")
else { 
//=================================================================
...
function clickMenuItem(strName, iMenuID, iMenuItemID) {
  ...
  if (objMenuItem.isPopup) {
    ...
    if(objMenuItem.title == "Designer")
	{
        objFrame.parent.frames[3].document.forms['bottomCommonForm'].DesignerSearch.value="true";
		objFrame.parent.frames[3].document.forms['bottomCommonForm'].CollectionsSearch.value="false";
	}
	if(objMenuItem.title == "Collections")
	{
		objFrame.parent.frames[3].document.forms['bottomCommonForm'].CollectionsSearch.value="true";
		objFrame.parent.frames[3].document.forms['bottomCommonForm'].DesignerSearch.value="false";
	}
