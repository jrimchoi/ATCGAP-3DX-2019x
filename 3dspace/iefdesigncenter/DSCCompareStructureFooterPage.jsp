<%--  DSCCompareStructureFooterPage.jsp
...
%>
    ...
    function previousPage()
    {
		...
		window.top.location.href =
            "DSCCompareStructureWizardFS.jsp?objectId=" + objectId
			+ "&HelpMarker=emxhelpdsccomparestructure";
        return;
    }
...
// System.out.println("CSRFINJECTION::DSCCompareStructureFooterPage.jsp");
%>
