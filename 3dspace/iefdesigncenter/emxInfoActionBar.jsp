...
--%>
<%--
  $Archive: /InfoCentral/src/infocentral/emxInfoActionBar.jsp $
  $Revision: 1.3.1.3$
...
<%--
 *
 * $History: emxInfoActionBar.jsp $
 * 
 * *****************  Version 13  *****************
 * User: Rahulp       Date: 03/01/21   Time: 20:05
 ...
 * 
 * *****************  Version 11  *****************
 * User: Snehalb      Date: 11/26/02   Time: 3:54p
 * Updated in $/InfoCentral/src/InfoCentral
 * 
 * *****************  Version 10  *****************
 * User: Mallikr      Date: 11/21/02   Time: 1:42p
 * Updated in $/InfoCentral/src/InfoCentral
 * for fixing the compilation error on HP. Commented logging the error
 * using NavError object
 * 
 * *****************  Version 9  *****************
 * User: Priteshb     Date: 11/18/02   Time: 3:24p
 * Updated in $/InfoCentral/src/InfoCentral
 * Indentation Clean Up
 * 
 * *****************  Version 7  *****************
 * User: Rahulp       Date: 10/31/02   Time: 11:11a
 * Updated in $/InfoCentral/src/InfoCentral
 * 
 * *****************  Version 6  *****************
 ...
 * 
 * *****************  Version 5  *****************
 * User: Rahulp       Date: 10/10/02   Time: 2:03p
 * Updated in $/InfoCentral/src/InfoCentral
 * 
 * *****************  Version 4  *****************
 ...
 * 
 * *****************  Version 3  *****************
 * User: Rahulp       Date: 10/01/02   Time: 2:35p
 * Updated in $/InfoCentral/src/InfoCentral
 * 
 * *****************  Version 2  *****************
 * User: Rahulp       Date: 9/20/02    Time: 6:54p
 * Updated in $/InfoCentral/src/InfoCentral
 * 
 * *****************  Version 1  *****************
 * User: Mallikr      Date: 9/18/02    Time: 11:33a
 * Created in $/InfoCentral/src/InfoCentral
 * emxActionBar enhanced with the feature to read "Popup Modal" property
 * from the settings
 *
 * ***********************************************
 *
...
<%!
        ...
        String expressionFilter) throws MatrixException
    {
        ...
        try
        {
            ...
            objMQL.executeCommand(context,"eval expr $1 on $2 $3",expressionFilter,"bus",busObj.getObjectId());
            ...
            if ( emxActionBarObject.isCommand(commandMap) )
            {
                    ...
                    && (sConfirmMessage.trim().length() > 0) )
                {
                    if (sConfirmMessage.indexOf("${") >= 0 )
                        sConfirmMessage = UINavigatorUtil.parseHREF(context, 
                            sConfirmMessage.trim(), 
                            sRegisteredSuite);
                    else
