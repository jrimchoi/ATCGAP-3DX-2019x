...
function selectAllDerivedOutputs(activeTabName, field)
{
	...
	var response						= appletObject.callTreeTableUIObject("selectAllDerivedOutputs", selectedFormFieldDetails);
...
function updatePreferences()
{
	...
	var response = appletObject.callTreeTableUIObject("updatePreferences", "");
...
{
	var response = appletObject.callTreeTableUIObject("updatePreferenceTables", "");
