<%--  MCADSaveAsAppletFreeOptiondialog.jsp
...
function silentSaveAs()
{
	...
	var saveAsDetails = "integrationName="+'<%=integrationName%>' + "&objectId=" + '<%=objectId%>' + "&regEx="+ regularExpr+"&replaceStr="+ replaceString+"&stdPart="+stdPart+"&folderId="+folderId+"&caddrawseries="+cadDrawSeries+"&cadmodelseries="+cadModelSeries+ "&objectIds=" + '<%=objectIds%>';
