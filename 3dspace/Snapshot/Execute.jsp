...
<%@page import="com.dassault_systemes.enovia.snapshot.services.SnapshotExecuteCallable"%>
...
<%	
	...
	try 
	{
		...
		//Validating the JPO with Snapshot Callable class-START
		FrameworkUtil.validateMethodBeforeInvoke(context, programName, methodName, com.dassault_systemes.enovia.snapshot.services.SnapshotExecuteCallable.class); 
		//END
