<%--
  FixedResourceRuleDisconnectPostProcess.jsp
...
<%@page import="com.matrixone.apps.configuration.FixedResource"%><html>
<head>
  ...
  try
  {
     ...
     //If the selection are made in Search results page then     
         ...
         //get the Object  ids of the table row ids passed    
          ...
          FixedResource.disconnect(context,strObjId,slBCRToRemove);
         %>
              <script language="javascript" type="text/javaScript">
//            <![CDATA[
