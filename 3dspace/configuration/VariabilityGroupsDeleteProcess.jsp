<%--
  VariabilityGroupsDeleteProcess.jsp
	  	...
	  	try{
		     ...
		     if(OIDsToDelete!=null){
		      ...
		      for(int i = 0; i < objMapList.size(); i++)
		      {
		    	  ...
		    	  if(lstVariabilityGroupChildTypes.contains(strObjType))
		    	  {
	        ...
	        if(bInvalidState == true){
		        ...
		        if(!hasDV){
		            ...
		            if(contentFrameObj.isDataModified()){//if SB is having any markup
			            ...
			            var vRes = emxUICore.getDataPost("../configuration/VariabilityGroupsDeleteProcess.jsp", urlParams);
