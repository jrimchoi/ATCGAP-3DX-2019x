...
<%--  GBOMActivePostProcess.jsp-- Will redirect to GBOMReplaceDialog with proper params
...
<%  
    ...
    if(strMode!=null  && strMode.equalsIgnoreCase("CustomGBOMActive")){
    	try{        
        ...
        boolean bFlag = logicalFTR.activeGBOM(context,slGBOMRelID);
    ...
    LogicalFeature logicalFTR= new LogicalFeature(strObjId);
        bFlag = logicalFTR.activeGBOM(context,slGBOMRelID);
    if (bFlag)
    {
        ...
        <script language="javascript" type="text/javaScript">
                ...
                var contentFrameObj =findFrame(getTopWindow(), "FTRContextInactiveParts");
