...
<%@page import="com.matrixone.apps.configuration.BooleanCompatibilityRule"%><html>
<head>
...
<%
  try
  {
     ...
     //If the selection are made in Search results page then     
         ...
         BooleanCompatibilityRule.delete(context,slBCRToRemove);
         %>
         <script language="javascript" type="text/javaScript">
//         <![CDATA[
