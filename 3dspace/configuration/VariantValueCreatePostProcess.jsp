<%--
  VariantValueCreatePostProcess.jsp
...
<%
  try
  {
	  ...
	  String relId = domObj.getInfo(context, "to["+ConfigurationConstants.RELATIONSHIP_VARIANT_VALUES+"].id");
