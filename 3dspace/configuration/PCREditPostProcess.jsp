...
//Values from Right Expression Component
  ...
  //Values from Completed Rule Component are not used for processing
      ...
      pcrExpMap.put("OldLEId",strOldLEId);
      pcrExpMap.put("OldLEText",strOldLEText);
      pcrExpMap.put("OldREId",strOldREId);
      pcrExpMap.put("OldREText",strOldREText);
...
%>
    ...
    var url= "../configuration/CreateRuleDialog.jsp?modetype=edit&commandName=FTRProductCompatibilityRuleSettings&ruleType=ProductCompatibilityRule&SuiteDirectory=configuration&suiteKey=configuration&parentOID="+contextOID+"&relId=null&suiteKey=configuration&objectId="+ruleID+"&submitURL=../configuration/PCREditPostProcess.jsp?mode=edit|objectId="+ruleID+"";
