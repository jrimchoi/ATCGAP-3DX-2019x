<%--
  ConfigurationFeatureDeleteProcess.jsp
		...
		//delete CF Ajax Call implementation-------
	  	try{
		     ...
		     if(OIDsToDelete!=null){
		      ...
		      ConfigurationFeature.delete(context, sLOIDsToDelete);                   
    		...
    		if (msg!=null && msg.indexOf("Check trigger blocked event")>= 0) {
    		  ...
    		  msg = msg.substring(msg.indexOf("#5000001:")+9);
		      action = "error";
		out.println("action=");
		out.println(action);
		out.println(",");
	        ...
	        if(bInvalidState == true){
		        ...
		        if(!hasDV){
		            ...
		            if(contentFrameObj.isDataModified()){//if SB is having any markup
			            ...
			            var vRes = emxUICore.getDataPost("../configuration/ConfigurationFeatureDeleteProcess.jsp", urlParams);
