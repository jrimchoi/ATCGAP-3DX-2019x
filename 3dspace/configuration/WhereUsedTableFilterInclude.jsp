...
<%@page import="com.matrixone.apps.domain.util.EnoviaResourceBundle"%><jsp:useBean id="tableBean" class="com.matrixone.apps.framework.ui.UITable" scope="session"/>
<%
...
String STR_LEVEL_ONE = EnoviaResourceBundle.getProperty(context,"Configuration","emxProduct.WhereUsed.LevelOne",acceptLanguage);
String STR_ALL = EnoviaResourceBundle.getProperty(context,"Configuration","emxProduct.Filter.All",acceptLanguage);
