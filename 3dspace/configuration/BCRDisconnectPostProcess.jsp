...
<%@page import="com.matrixone.apps.configuration.BooleanCompatibilityRule"%>
  ...
  try
  {
     ...
     //If the selection are made in Search results page then     
         ...
         //get the Object  ids of the table row ids passed    
          ...
          StringList slBCRToRemove= new StringList(arrRelIds);
          BooleanCompatibilityRule.disconnect(context,strObjId,slBCRToRemove);
         %>
              <script language="javascript" type="text/javaScript">
//            <![CDATA[
