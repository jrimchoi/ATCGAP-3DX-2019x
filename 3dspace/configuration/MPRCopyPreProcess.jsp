...
try
 ...
 %>
  <script language="javascript" type="text/javaScript">
   var url= "../configuration/CreateRuleDialog.jsp?modetype=copy&commandName=FTRMarketingPreferenceRuleSettings&ruleType=MarketingPreferenceRule&SuiteDirectory=configuration&suiteKey=configuration&productID=<%=XSSUtil.encodeForURL(context,contextOID)%>&relId=null&suiteKey=configuration&objectId=<%=XSSUtil.encodeForURL(context,strObject)%>&submitURL=../configuration/MPRCopyPostProcess.jsp?mode=copy|objectId=<%=XSSUtil.encodeForURL(context,strObject)%>";
