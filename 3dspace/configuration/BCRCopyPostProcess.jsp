...
try
 {
  ...
  String strProduct = emxGetParameter(request, "product");
...
<%
    	...
    	//top.getWindowOpener().location.href = getTopWindow().getWindowOpener().location.href;
    	 //getTopWindow().getWindowOpener().editableTable.loadData();
                  ...
                  var listFrame=window.parent.getTopWindow().getWindowOpener().getTopWindow().getWindowOpener().parent;
