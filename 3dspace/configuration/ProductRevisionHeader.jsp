...
<input type="hidden" name="pheader" value=""/>
  <table>
    <tr>
			...
			{			    
			    pageHeader = "emxProduct.Heading.ProductRevisionFlatViewContentFSDialog";
			...
			else if(strFunctionality.equals("ProductVariantCreateFlatViewContentFSInstance"))
			{
			    ...
			    pageHeader = "emxProduct.Heading.ProductVariantSelectFeature";
			    bPrinterFriendly = false;
			}
			else if(strFunctionality.equals("ProductRevisionEditOptionsContentFSInstance"))
			{
			    //Fix for Bug 366115 - Change in the header.
			    //pageHeader = "emxProduct.Heading.ProductRevisionEdit";
			    pageHeader = "emxProduct.Heading.ProductRevisionEditOptionsContentFSInstance";
			    bPrinterFriendly = false;			    
			}
			else
			{		    
			...
			%>
			<td class="page-title">
            <h2><emxUtil:i18n localize="i18nId"><%=XSSUtil.encodeForHTML(context,pageHeader)%></emxUtil:i18n></h2></td>
