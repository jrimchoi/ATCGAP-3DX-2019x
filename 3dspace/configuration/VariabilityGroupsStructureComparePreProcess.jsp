<%--
  VariabilityGroupsStructureComparePreProcess.jsp
	 ...
	 if(strArrSelectedTableRowId != null && strObjIdContext == null){
		...
		%>
	     <script language="javascript" type="text/javaScript">          
	           	 var url = "../common/emxForm.jsp?form=FTRVariabilityGroupStructureCompareForm&mode=Edit&formHeader=emxConfiguration.Command.CompareVariabilityGroupViews&editLink=true&suiteKey=Configuration&featureType=VariabilityGroup&isSelfTargeted=true&cancelProcessURL=../common/emxCloseWindow.jsp&postProcessURL=../configuration/StructureCompareProcess.jsp&HelpMarker=emxhelpvariabilitygroupstructurecompare&objectId=<%=strObjIdContext%>";
