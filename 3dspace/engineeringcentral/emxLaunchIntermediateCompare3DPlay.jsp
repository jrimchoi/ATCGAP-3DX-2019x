...
<script language="javascript">
	...
	var compareTableName =sbReference.name;
	...
	if(typeof oXML != 'undefined' && oXML != null) {
		...
		document.location.href = "emxLaunch3DPlayCheck.jsp?3DCompare=true&objectId1="+objectId1+"&objectId2="+objectId2+"&currentCompareTableName="+compareTableName;
	} else {
