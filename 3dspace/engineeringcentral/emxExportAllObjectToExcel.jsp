...
<%@page
	import="com.matrixone.apps.domain.util.EnoviaBrowserUtility.Browsers"%>
...
<%
	...
	boolean isMoz = EnoviaBrowserUtility.is(request,
			Browsers.MOZILLAFAMILY);
	...
	{
		//TODO: Check with BPS if the Bean is loaded with this call
		...
		ExportToExcelUtil.startExportToExcelBackgroundJob(context,programMap);
	}
