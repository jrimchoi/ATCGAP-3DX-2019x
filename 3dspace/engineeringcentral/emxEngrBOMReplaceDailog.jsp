...
<form name="formReplacePart" method="post" action="emxEngrBOMReplaceProcess.jsp" target="_parent" onSubmit="javascript:doDone(); return false">
    ...
    <input type="hidden" name="BOMViewMode" id="BOMViewMode" value="<xss:encodeForHTMLAttribute><%=BOMViewMode%></xss:encodeForHTMLAttribute>" />
    <input type="hidden" name="WorkUnderOID" id="WorkUnderOID" value="<xss:encodeForHTMLAttribute><%=WorkUnderOID%></xss:encodeForHTMLAttribute>" />
    <input type="hidden" name="replaceRowQuantity" id="replaceRowQuantity" value="<xss:encodeForHTMLAttribute><%=replaceRowQuantity%></xss:encodeForHTMLAttribute>" />
    ...
    <input type="hidden" name="frameName" id="frameName" value="<xss:encodeForHTMLAttribute><%=frameName%></xss:encodeForHTMLAttribute>" />
     <!-- Added for Part Create conversion to common comp. R211 --> 
