...
<%
        ...
        if(isLaunch3dPlay) {
            ...
            if(emxGetParameter(request, "3DCompare") != null) {
                ...
                contentURL.append("objectId1=").append(XSSUtil.encodeForURL(context, objectId1)).append("&objectId2=").append(XSSUtil.encodeForURL(context, objectId2)).append("&currentCompareTableName=").append(XSSUtil.encodeForURL(context, currentCompareTableName)).append("&");
            }
