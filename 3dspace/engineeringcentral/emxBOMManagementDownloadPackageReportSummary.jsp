<%--  emxBOMManagementDownloadPackageReportSummary.jsp -  This page displays a list of specs for a part (CAD Drawing, CAD Model, Drawing Print)
...
contentURL.append("emxBOMManagementDownloadPackageReportDialogFS.jsp?");
...
function doneMethod()  {
    if (jsDblClick()) {
    	document.formPackageSummary.action="emxBOMManagementDownloadPackageTransferProcess.jsp?objectId=<%=XSSUtil.encodeForURL(context,partId)%>";
        document.formPackageSummary.submit();
    } else {
...
%>
    ...
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.Level</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.Name</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.Revision</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.Type</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.Description</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.State</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.Quantity</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.UOM</emxUtil:i18n></b></th>
    <th nowrap="nowrap"><b><emxUtil:i18n localize="i18nId">emxBOMManagement.DownloadPackage.FileSize</emxUtil:i18n></b></th>
