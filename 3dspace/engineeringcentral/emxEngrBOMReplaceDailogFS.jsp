...
<%
  ...
  String contentURL = "emxEngrBOMReplaceDailog.jsp";
  ...
  contentURL += "&selPartRelId="+selPartRelId+"&totalCount="+totalCount+"&replaceWithExisting="+replaceWithExisting+"&sRowId="+sRowId+"&relType="+relType+"&frameName="+frameName+"&tablemode="+tablemode+"&hideWithBOMSelection="+hideWithBOMSelection+"&BOMViewMode="+BOMViewMode+"&replaceRowQuantity="+replaceRowQuantity+"&WorkUnderOID="+WorkUnderOID;
