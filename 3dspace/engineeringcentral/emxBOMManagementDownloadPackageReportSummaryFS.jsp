<%-- emxBOMManagementDownloadPackageReportSummaryFS.jsp - This page is the Frameset for reviewing specification summary.
...
<%
  ...
  String tableBeanName = "emxBOMManagementPackageReportSummaryFS";
  ...
  String objectId = emxGetParameter(request,"objectId");
		...
		contentURL.append("emxBOMManagementDownloadPackageReportSummary.jsp?");
  ...
  String PageHeading = "emxBOMManagement.DownloadPackage.PackageReportPageHeaderStep2";
  ...
  if (acc.has(Access.cRead)) {
   ...
   fs.createFooterLink("emxEngineeringCentral.Button.Previous",
                      "prevMethod()",
                       roleList,
                      false,
                      true,
   ...
   fs.createCommonLink("emxEngineeringCentral.Button.Done",
                      "doneMethod()",
                       roleList,
                      false,
                      true,
