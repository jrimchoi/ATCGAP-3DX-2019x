...
function addReviewSelectors(){
	...
	var sURL=	'../common/emxFullSearch.jsp?field=TYPES=type_Person:CURRENT=policy_Person.state_Active:NAME!=<%=strUser%>&excludeOID='+ReviewersHidden.value+'&table=AEFGeneralSearchResults&selection=multiple&hideHeader=true&submitURL=../enterprisechangemgtapp/ECMUtil.jsp?mode=searchUtilReviewer&targetTag=select&selectName=Reviewers';
