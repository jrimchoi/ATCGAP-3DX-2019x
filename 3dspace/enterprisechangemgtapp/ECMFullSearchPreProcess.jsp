...
<%
	...
	try{
		...
		else if("CAAffectedItemsAddExisting".equalsIgnoreCase(functionality))
		{
			...
			// Adding objects from multiple colab space to CA
			...
			searchURL	+= "&table=AEFGeneralSearchResults&selection=multiple&searchOnInit=false&showSavedQuery=True&searchCollectionEnabled=True&field=TYPES="+searchTypes+"&submitURL=../enterprisechangemgtapp/ECMFullSearchPostProcess.jsp?submitAction=refreshCaller";
		}
		else if("AffectedItemsAddExisting".equalsIgnoreCase(functionality)) 
		{
			//Modeler API to get the allowed seach type
			searchTypes=strProposedActivityList;
			searchURL	+= "&table=AEFGeneralSearchResults&selection=multiple&searchOnInit=false&showSavedQuery=True&searchCollectionEnabled=True&field=TYPES="+searchTypes+":PROJECT="+searchProject+"&submitURL=../enterprisechangemgtapp/ECMFullSearchPostProcess.jsp?submitAction=refreshCaller";
		}
