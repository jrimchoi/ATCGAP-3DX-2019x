...
function sleep(delay) {
	...
	try 
	{
		...
		strURL = "../contacts/ExecutePostActions.jsp";
		...
		FrameworkUtil.validateMethodBeforeInvoke(context, programName, methodName, com.dassault_systemes.enovia.contacts.ContactsExecuteCallable.class);
