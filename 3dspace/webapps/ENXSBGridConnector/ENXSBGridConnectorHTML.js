    ...
    **/
    var gridType = "NONE";
    var dataGridModel, dgView, dgToolbar,alertMessageNotification, graph, displayModesColumnsArray = [], addEventListenersTo = [], tableViewEventListener = [], expandProgramViewEventListener = [];
	var emxExpandFilter, expandLevel = 0, fromExpandCommand = false, dataGridEnabled = true;
