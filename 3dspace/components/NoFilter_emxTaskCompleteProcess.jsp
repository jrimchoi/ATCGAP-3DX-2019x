...
if(getTopWindow().getWindowOpener())
{
  ...
  else if(parent.getTopWindow())
{
	var frameName = (parent.getTopWindow() && parent.getTopWindow().getTopWindow().getWindowOpener())? parent.getTopWindow().getTopWindow().getWindowOpener():parent.getTopWindow().getTopWindow();
    var frame = findFrame(frameName, "portalDisplay");
    if(parent.getTopWindow() && !frame) {
    	var pageContentFrame = openerFindFrame(getTopWindow(),"pagecontent");
        if(pageContentFrame){
        	pageContentFrame.document.location.href = pageContentFrame.document.location.href;
        }
