...
<body>
	...
	<script language="javascript">
		/*var strURL = "emxFullSearch.jsp?table=AppFolderContentSearchResult&showInitialResults=false&default=TYPE=type_Document&field=TYPES=<%=searchTypes%>:IS_VERSION_OBJECT!=True&HelpMarker=emxhelpsearch&SubmitLabel=emxTeamCentral.Common.Done&header=emxTeamCentral.Common.SelectContent&form=TMCAddWorkspaceContentForm&selection=multiple&targetLocation=popup&SelectAbstractTypes=true<%=otherParams%>&submitURL=../teamcentral/emxTeamFolderAttachDocuments.jsp";*/
		var strURL = "emxFullSearch.jsp?showInitialResults=false&searchOnInit=false&default=TYPE=type_Document&field=TYPES=<%=searchTypes%>:IS_VERSION_OBJECT!=True&HelpMarker=emxhelpsearch&SubmitLabel=emxTeamCentral.Common.Done&header=emxTeamCentral.Common.SelectContent&form=TMCAddWorkspaceContentForm&selection=multiple&targetLocation=popup&SelectAbstractTypes=true<%=otherParams%>&submitURL=../teamcentral/emxTeamFolderAttachDocuments.jsp";
