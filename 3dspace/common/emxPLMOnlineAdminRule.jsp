...
<%
	...
	String contentURL = "emxPLMOnlineAdminRuleQueryContent.jsp?"+emxGetQueryString(request); 
	...
	//String pageHeading = "Query for Rule";
	String pageHeading = getSafeNLS("Access.Rule.Query");
