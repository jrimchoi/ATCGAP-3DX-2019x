...
<%
	...
	String contentURL = "emxPLMOnlineAdminRelationshipQueryContent.jsp?"+emxGetQueryString(request); 
	...
	//String pageHeading = "Query for Relationship";
	String pageHeading = getSafeNLS("Access.Relationship.Query");
