...
<html>
    ...
    String modelUnPublished 	= UINavigatorUtil.getI18nString("emxVPLMSynchroCfg.Info.ModelUnpublished", "emxVPLMSynchroCfgStringResource", request.getHeader("Accept-Language"));
    String ProdLineUnpublished 	= UINavigatorUtil.getI18nString("emxVPLMSynchroCfg.Info.ProdLineUnpublished", "emxVPLMSynchroCfgStringResource", request.getHeader("Accept-Language"));
    ...
    String ManufPlanUnPublished = UINavigatorUtil.getI18nString("emxVPLMSynchroCfg.Info.ManufPlanUnpublished", "emxVPLMSynchroCfgStringResource", request.getHeader("Accept-Language"));
	...
	int    VPMsize 				= 0;
		...
		String TypeStatus  			= request.getParameter("chkType");
		...
		String ManufPlanStatus		= request.getParameter("chkManufPlan");
    		...
    		if(TypeStatus != null){syncVersion += "_Type";}
    		...
    		if(ProdConfStatus != null){syncVersion += "_ProdConf";}
    		if(LINStatus != null){syncVersion += "_LIN";}
    		if(ManufPlanStatus != null){syncVersion += "_ManufPlan";}
		syncVersion += "_unpublish";
        ...
        Map matrixObjIDvplmObjIDMap = (Map)JPO.invoke(context, "VPLMIntegSyncWithVPLM", null, "execute", args, Map.class);
			...
			// Write number of objects unpublished
			...
			buildSynchro  	= (String)matrixObjIDvplmObjIDMap.get("buildSynchro");
				...
				buildSynchro = UINavigatorUtil.getI18nString("emxVPLMSynchroCfg.Info.BuildUnpublished", "emxVPLMSynchroCfgStringResource", request.getHeader("Accept-Language"));
				}else{
				buildSynchro = UINavigatorUtil.getI18nString("emxVPLMSynchroCfg.Info.NoBuildUnpublished", "emxVPLMSynchroCfgStringResource", request.getHeader("Accept-Language"));			
			}

				if((modelSize.equals("0")) && (prodLineSize.equals("0")) && (!buildSynchro.equalsIgnoreCase("true"))){
    			// Nothing to unpublish
    			msgString = UINavigatorUtil.getI18nString("emxVPLMSynchroCfg.Info.NothingToUnpublish", "emxVPLMSynchroCfgStringResource", request.getHeader("Accept-Language"));
			}
    ...
    %>
			    ...
			    <tr>
			        ...
			        <tr>
						<td class="inputField">
							<p><%=prodLineSize%> <%=ProdLineUnpublished%></p>
							<p><%=modelSize%> <%=modelUnPublished%></p>
							<p><%=buildSynchro%></p>
							<p><%=ManufPlanSize%> <%=ManufPlanUnPublished%></p>
