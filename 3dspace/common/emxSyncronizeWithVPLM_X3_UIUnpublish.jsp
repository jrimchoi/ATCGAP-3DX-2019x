    ...
    boolean isIE = browser.indexOf("MSIE") > 0;
  	...
  	<body class="slide-in-panel" onload="turnOffProgress();">
		...
		<div id="divPageBody" <%if(isIE){%> style="top:85px;" <%}%>>
			<iframe name="syncDisplayFrame" src="../common/emxSyncronizeWithVPLM_X3_UIUnpublishForm.jsp?id=<%=XSSUtil.encodeForURL(context,sProdID)%>&targetLocation=<%=XSSUtil.encodeForURL(context,targetLocation)%>"></iframe>
		</div>
