...
//String pgHead	= myNLS.getMessage("emxPlmOnline.label.DataModeling");

String timeStamp = Long.toString(System.currentTimeMillis());

String contentURL = "emxPLMOnlineAdminXPDataModelSummary.jsp";
String objectId = emxGetParameter(request,"objectId");

%>

<jsp:include page = "../common/emxToolbar.jsp" flush="false">
<jsp:param name="toolbar" value="APPXPDataModelMenu"/>
