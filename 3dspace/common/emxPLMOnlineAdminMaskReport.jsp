...
<head>
	...
	<%
		...
		String maskName = emxGetParameter(request, "maskName");
		maskName = FrameworkUtil.decodeURL(maskName, sCharSet);
		//out.println("maskName: " + maskName);

		//get results
		String queryResult = "";
		try{
			queryResult = MqlUtil.mqlCommand(context,"print command $1","mask::" + maskName);
		}
		catch (Exception ex) {
		...
		<%
			addBar(out, "barTDInReport", maskName, "mainDiv", currentLevel);
		%>
		</div>
