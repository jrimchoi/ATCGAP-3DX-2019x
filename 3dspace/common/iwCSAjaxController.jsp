...
if (colonIndex > -1) {
    ...
    optionMap = (TreeMap) JPO.invoke(context, programName, null, programMethod, methodArgs, TreeMap.class);
// Else it's just the name of the program that contains the CSL choices
} else {
    optionMap = (TreeMap) JPO.invoke(context, "iwCSLUtil", null, "getCSLChoices", methodArgs, TreeMap.class);
}
