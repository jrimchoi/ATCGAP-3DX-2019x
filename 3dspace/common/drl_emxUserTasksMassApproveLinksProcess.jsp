...
<%
    ...
    if(fromPage.equals("AEFLifecycleMassApproveTask")) {
		...
		//Added cancelProcessURL and fromPage param for 3dxtools routes enhancement
        action = "emxTableEdit.jsp?program=emxLifecycle:getAllAssignedTasks&table=AEFMyTaskMassApprovalSummary&selection=multiple&header=emxComponents.Common.TaskMassApproval&postProcessURL=emxLifecycleTasksMassApprovalProcess.jsp&HelpMarker=emxhelpmytaskmassapprove&suiteKey=Components&StringResourceFileId=emxComponentsStringResource&SuiteDirectory=component&cancelProcessURL=../common/emxTableCleanupSession.jsp&fromPage="+fromPage;
