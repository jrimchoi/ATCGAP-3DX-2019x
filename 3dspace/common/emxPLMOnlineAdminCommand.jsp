...
<%
	...
	String contentURL = "emxPLMOnlineAdminCommandQueryContent.jsp?"+emxGetQueryString(request); 
	...
	//String pageHeading = "Query for Command";
	String pageHeading = getSafeNLS("Access.Command.Query");
