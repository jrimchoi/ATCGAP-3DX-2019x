...
<%
  ...
  contentURL.append("emxVPLMProcPublicAttributesSummary.jsp");
  ...
  String PageHeading = "emxVPLMProcessEditor.Header.Properties";
  ...
  fs.setStringResourceFile("emxVPLMProcessEditorStringResource");
