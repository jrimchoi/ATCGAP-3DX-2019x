...
<head>
	...
	<script language="javascript">
			...
			function submitQuery(){
				...
				var relationshipPattern = getAllCheckboxValues("relationshipQueryForm", "relationshipCheckbox", "relationshipTextboxId");

				//submit form
				document.relationshipQueryForm.action = "emxPLMOnlineAdminRelationshipQueryResult.jsp";
				document.relationshipQueryForm.submit();
				//startProgressBar();
			}
...
<body onload="init();">
	<%
        ...
        String i18_byName    = getNLS("Access.Relationship.Query.byName");
        String i18_Name      = getNLS("Access.Relationship.Query.Name");
	%>

<form name="relationshipQueryForm" target="_parent">
	...
	<table border="1" cellspacing="0" cellpadding="0" width="100%" >
		<tr>
			...
			<td width="7%" class="barTDInQuery" ><img src="../common/images/buttonChannelCollapse.gif" id="relationshipImgId" onclick="switchMenu('divByPolicy', this, 'expandCollapse');"/></td>
		</tr>
	...
	<div id="divByPolicy">
		<table border="0" cellpadding="3" cellspacing="2" width="100%">
			<tr>
				...
				<td class="inputField"> <input type="text" name="relationshipPattern" id="relationshipTextboxId"  style="width:220px" value="*">
				</td>
			</tr>
