...
<%
  ...
  String contentURL = "cenitSAPChangePasswordForm.jsp";
  ...
  String PageHeading = "Update SAP Credentials";

  // Marker to pass into Help Pages
  // icon launches new window with help frameset inside
 // String HelpMarker = "emxhelpchangepassword";

  fs.initFrameset(PageHeading,null,contentURL,false,false,false,false);
