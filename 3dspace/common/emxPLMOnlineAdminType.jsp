...
<%
	...
	String contentURL = "emxPLMOnlineAdminTypeQueryContent.jsp?"+emxGetQueryString(request); 
	...
	//String pageHeading = "Query for Type";
	String pageHeading = getSafeNLS("Access.Type.Query");
