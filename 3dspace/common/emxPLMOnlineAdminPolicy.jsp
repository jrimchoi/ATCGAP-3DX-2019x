<%--  emxComponentsPeopleQueryFS.jsp -- This page displays the details of Policies.
...
<%
	...
	String contentURL = "emxPLMOnlineAdminPolicyQueryContent.jsp?"+emxGetQueryString(request); 
	...
	//String pageHeading = "Query for Policy";
	String pageHeading = getSafeNLS("Access.Policy.Query");
